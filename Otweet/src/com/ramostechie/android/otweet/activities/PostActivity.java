...
import com.ramostechie.android.otweet.tasks.PostPhotoAsyncTask;
import com.ramostechie.android.otweet.tasks.PostPhotoAsyncTask.PostPhotoResponder;
import com.ramostechie.android.otweet.tasks.PostTweetAsyncTask;
import com.ramostechie.android.otweet.tasks.PostTweetAsyncTask.PostTweetResponder;
...
public class PostActivity extends Activity implements PostTweetResponder, PostPhotoResponder  {
	...
	@Override
	//called when the user finishes the activity in openPhotoLibrary as the intent sends back a result  
	...
	protected void photoToPostChosen(Uri uri) {
	    ...
	    if (null != id) {
	      ...
	      /*photoButton.setBackground(new BitmapDrawable(thumbBitmap));*/
	    }
	}
